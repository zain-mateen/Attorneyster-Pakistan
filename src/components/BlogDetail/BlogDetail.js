...
import Image from '../../img/About-story-img3.png'; 
    ...
    <div className='BlogDetail'>
      <div className='container'>
        ...
        <div className='content_otr'>
          <p className='date heading-m'>Legal Advice   |   Sunday, July 19, 2022   </p>
          <h1 className='heading heading-h1'>Failing to Carry Out The Terms of <br />A Business Contract</h1>
          ...
          <h2 className=' heading2 heading-h2'>Equal Justice for all Livings</h2>
          <p className='desc heading-m'>
          ...
          <div className='box_otr'>
            <div className='box_inr'>
              <h4 className='box_heading heading-h4'>“Democracy must be built through open societies that share information. When there is information, there is enlightenment. When there is no sharing of power, no rule of law, no accountability, there is abuse, corruption, subjugation and indignation.”</h4>
            </div>
          </div>
          <h2 className='heading3 heading-h2'>Make real time a law services</h2>
          <p className='desc heading-m'>
